...
def cleardb():
    ...
    mongo.worker_collection.remove({})
...
def mock_json_jarbas_search():
    return {
        ...
        "results": [
            {
                "all_net_values": [6000.0],
                "all_reimbursement_numbers": [6118],
                ...
                "suspicions": "null",
                "receipt_text": "null",
                "search_vector": "'02605452000122':10A 'automotiv':13 'chart':17 'club':5A 'júnior':2A 'locador':6A "
                "'ltda':9A 'or':16 'pr':11A 'renting':15 'servic':4A,8A 'to':12B 'vehicl':14 'vicentinh':1A 'vip':3A",
            },
            {
                "all_net_values": [14900.0],
                "all_reimbursement_numbers": [6115],
                "all_reimbursement_values": [0.0],
                ...
                "suspicions": "null",
                "receipt_text": "null",
                "search_vector": "'75543611000185':6A 'aer':4A 'aircraft':9,14 'chart':12 'giacob':1A 'helisul':2A"
                " 'ltda':5A 'of':13 'or':11 'pr':7A,8B 'renting':10 'tax':3A",
            },
            {
                "all_net_values": [6990.0],
                "all_reimbursement_numbers": [6114],
                "all_reimbursement_values": [0.0],
                ...
                "suspicions": "null",
                "receipt_text": "null",
                "search_vector": "'21138576000190':4A 'ac':6B 'activity':10 'ltda':3A 'mobobits':2A 'of':8 "
                "'parliamentary':9 'psdb':5A 'publicity':7 'roch':1A",
            },
            {
                "all_net_values": [5780.0],
                "all_reimbursement_numbers": [6117],
                "all_reimbursement_values": [0.0],
                ...
                "suspicions": "null",
                "receipt_text": "null",
                "search_vector": "'14082069000116':8A 'and':12 'automotor':15 'chapadinh':2A 'combustiv':6A 'comerci'"
                ":4A 'francisc':1A 'fuels':11 'ltda':7A 'lubricants':13 'pa':10B 'petrosan':3A 'pod':9A 'veícul':14",
            },
            {
                "all_net_values": [3000.0],
                "all_reimbursement_numbers": [6114],
                "all_reimbursement_values": [0.0],
                ...
                "suspicions": "null",
                "receipt_text": "null",
                "search_vector": "'03514281000199':8A 'automotiv':11 'barret':5A 'benedet':2A 'c':4A 'chart':15 'eirel'"
                ":7A 'or':14 'pmdb':9A 'renting':13 'ronald':1A 'sc':10B 'turism':6A 'vehicl':12",
            },
            {
                "all_net_values": [130.0],
                "all_reimbursement_numbers": [6117],
                "all_reimbursement_values": [0.0],
                ...
                "suspicions": "null",
                "receipt_text": "null",
                "search_vector": "'72629140000134':7A 'congressperson':13 'distrit':15 'except':11 'federal':16 'from'"
                ":14 'hotel':4A 'lodging':10 'lucen':3A 'nacional':5A 'pv':8A 'robert':1A 's/a':6A 'sp':9B",
            },
            {
                "all_net_values": [200.0],
                "all_reimbursement_numbers": [6114],
                "all_reimbursement_values": [0.0],
                ...
                "suspicions": "null",
                "receipt_text": "null",
                "search_vector": "'08657922000188':8A 'activity':14 'cels':1A 'empres':3A 'expressã':6A 'jornal':5A "
                "'jornalíst':4A 'ltda':7A 'maldan':2A 'of':12 'parliamentary':13 'pmdb':9A 'publicity':11 'sc':10B",
            },
        ],
    }
        ...
        "results": [
            {
                ...
                "receipt_text": "null",
                "search_vector": "'17314329004460':8A 'alimentaca':6A 'andrad':2A 'company':5A 'congressperson':11 "
                "'international':3A 'meal':4A,12 'mg':10B 'pp':9A 'renat':1A 's.a':7A",
            },
            {
                ...
                "receipt_text": "null",
                "search_vector": "'aprendizag':6A 'colatt':2A 'comercial':7A 'congressperson':11 'meal':12 'nacional'"
                ":4A 'pmdb':9A 'sc':10B 'senac':8A 'servic':3A 'vald':1A",
            },
            {
                ...
                "suspicions": {"meal_price_outlier": True},
                "receipt_text": "null",
                "search_vector": "'03953506000103':9A 'belin':4A 'congressperson':10 'gastronom':7A 'lideranc':1A "
                "'ltda':8A 'meal':11 'paes':5A 'psdb':3A",
            },
            {
                ...
                "suspicions": {"meal_price_outlier": True},
                "receipt_text": "null",
                "search_vector": "'33447301000117':7A 'aliment':5A 'comerci':3A 'congressperson':8 'ltda':6A 'meal':9 "
                "'phs':1A 'taiob':2A",
            },
            {
                ...
                "suspicions": {"meal_price_outlier": True},
                "receipt_text": "null",
                "search_vector": "'26171763000199':10A 'buffet':5A 'congressperson':11 'gourmet':7A 'lim':4A 'ltda':9A "
                "'ltda-m':8A 'maison':6A 'meal':12 'sdd':1A 'vasconcel':2A",
            },
            {
                ...
                "suspicions": {"meal_price_outlier": True},
                "receipt_text": "null",
                "search_vector": "'03346671000954':8A 'cd':2A 'congressperson':9 'epp':7A 'lid.gov':1A 'ltda':6A 'meal'"
                ":10 'self':4A 'servic':5A 'taiob':3A",
            },
            {
                ...
                "suspicions": {"meal_price_outlier": True},
                "receipt_text": "null",
                "search_vector": "'18440959168':7A '27570249000199':8A 'antoni':4A 'borg':6A 'congressperson':9 "
                "'girott':5A 'lideranc':1A 'meal':10 'pt':3A",
            },
        ],
    }
